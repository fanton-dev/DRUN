...
import {QueueLibrary, QueueMessage, SharedQueue} from '../@types/shared-queue';
 ...
 * @return {SharedQueue} - shared queue interface object
 */
export default function buildSharedQueue({
  queueLibrary,
  queueUrl,
